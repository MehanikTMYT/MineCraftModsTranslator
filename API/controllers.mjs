//controllers.mjs
import { processJar, validateParams, path } from './utils.mjs';
...
async function processJarFile(req, res) {
    const options = {
      ...
      f: req.body.f || 'en',
      t: req.body.t || 'ru',
      translateMethod: req.body.translateMethod || 'local',
    };
    ...
    try {
      ...
      const result = await processJar(jarPath, options, translateText);
      if (result.success) {
